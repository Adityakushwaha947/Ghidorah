...
`apps/ghidorah/scripts/mastra-recovery-patch.mjs` patches two statements in each published ESM/CommonJS agent bundle:
...
- `bun run patch:check` checks the installed version and both complete bundle SHA-256 hashes without changing files.
