...
import { CONTRACT_VERSION, FIXTURE_TARGET, fixtureConfig, type RunHandle } from "./foundation/fixture-contract.js";
...
try {
  ...
  if (!command || command === "help" || command === "--help") {
    ...
    if (command === "inspect") {
      ...
      handle =
        command === "fixture" ? backend.run(FIXTURE_TARGET, fixtureConfig()) : backend.recover(argument!, context);
