...
import { CONTRACT_VERSION, FIXTURE_TARGET, fixtureConfig } from "../../src/foundation/contracts.js";
...
try {
  const handle = resumeRunId ? backend.recover(resumeRunId, { contractVersion: CONTRACT_VERSION }) : backend.run(FIXTURE_TARGET, fixtureConfig());
